let array:any=localStorage.getItem("bookList");
if(!array)
{
    array=[];
...
deleteRecord(del:any){
 ...
 addBookList(){
     let id1=(<HTMLInputElement>document.getElementById("iName")).value; // as HTMLInputElement
     console.log(id1);
     
     let title=(<HTMLInputElement>document.getElementById("tName")).value;
     let author=(<HTMLInputElement>document.getElementById("aName")).value;
     let rating=(<HTMLInputElement>document.getElementById("rName")).value;
 ...
 displayBookList(){
  ...
  search(){
      count++;
    let input = document.getElementById('searchBooks') as HTMLInputElement;
...
let searchBtn:bookManager= new bookManager();
let result=document.getElementById("btn1")?.addEventListener("click",search1);// object is possibly null so i use ? ,optional
